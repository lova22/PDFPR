...
import { Lock, File as FileIcon, Loader2, Download, AlertCircle, RefreshCw, CheckCircle2, Eye, EyeOff } from "lucide-react";
import { useDropzone } from "react-dropzone";
import { motion, AnimatePresence } from "framer-motion";
import { queueProtectPdfJob } from "@/app/actions/queueProtectPdfJob";
...
export default function ProtectPdfClient() {
  ...
  const handleProtect = async () => {
    ...
    try {
      ...
      // Anonymous or authenticated processing
      ...
      const res = await queueProtectPdfJob(originalStoragePath, password);
      ...
      pollIntervalRef.current = setInterval(async () => {
        ...
        if (job.status === 'completed' && job.result_file_path) {
          ...
          if (pollIntervalRef.current) clearInterval(pollIntervalRef.current);
          setErrorMessage(job.error_message || "Protection failed unexpectedly.");
          setStatus("error");
        }
      }, 2000);
  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center mb-10">
        <div className="bg-purple-100 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-5 border border-purple-200">
        ...
        <p className="text-gray-500 text-lg max-w-xl mx-auto leading-relaxed">
          Secure your PDF file with AES-256 password encryption.
        </p>
      </div>
            ...
            <AnimatePresence mode="wait">
              ...
              {file && status !== "completed" && status !== "error" && (
                <motion.div
                  ...
                  className="w-full"
                >
                  <div className="bg-purple-50 border border-purple-100 rounded-2xl p-6 mb-8 flex items-center gap-4">
                    ...
                    <div className="mb-8">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all text-gray-800 text-lg outline-none pr-12"
                        />
                        <button
                          type="button"
                  ...
                  {status === "processing" && (
                    <div className="mb-8">
                      ...
                      <p className="text-center text-sm text-gray-500 mt-4 flex items-center justify-center gap-2">
                        <Loader2 className="w-4 h-4 animate-spin" /> Securing document with AES-256...
                      </p>
                    </div>
                  )}
                  ...
                  <div className="flex justify-center gap-4 mt-8">
                    ...
                    <button 
                      ...
                      className="px-8 py-3 font-bold text-white bg-purple-600 hover:bg-purple-700 rounded-xl transition-all shadow-md shadow-purple-200 hover:shadow-lg disabled:opacity-50 flex items-center gap-2"
                    >
                      {status === "processing" ? (
              ...
              {status === "completed" && downloadUrl && (
                ...
                >
                  ...
                  <p className="text-gray-500 mb-8 max-w-sm mx-auto">
                    Your PDF has been securely encrypted and is ready for download.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <a 
                      ...
                      className="flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-bold py-4 px-8 rounded-xl transition-all shadow-md shadow-purple-200 hover:shadow-lg"
                    >
