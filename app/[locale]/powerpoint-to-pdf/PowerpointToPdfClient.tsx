...
import { MonitorPlay, File as FileIcon, Loader2, Download, AlertCircle, RefreshCw, CheckCircle2 } from "lucide-react";
import { useDropzone } from "react-dropzone";
import { motion, AnimatePresence } from "framer-motion";
import { queuePowerpointToPdfJob } from "@/app/actions/queuePowerpointToPdfJob";
...
export default function PowerpointToPdfClient() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const res = await queuePowerpointToPdfJob(originalStoragePath);
    ...
    <div className="w-full">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 text-lg max-w-xl mx-auto leading-relaxed">
          Convert your PPT and PPTX presentations into high-quality PDF documents.
        </p>
      </div>
            ...
            <AnimatePresence mode="wait">
              ...
              {!file && (
                ...
                >
                  ...
                  <p className="text-xl font-bold text-gray-800 mb-2">Drop your PowerPoint here</p>
                  ...
                  <div className="flex justify-center gap-4 mt-8">
                    ...
                    >
                      {status === "processing" ? (
                        ...
                        <><MonitorPlay className="w-5 h-5" /> Convert to PDF</>
                      )}
                    </button>
                  </div>
                </motion.div>
              ...
              {status === "completed" && downloadUrl && (
                ...
                >
                  ...
                  <p className="text-gray-500 mb-8 max-w-sm mx-auto">
                    Your PowerPoint has been successfully converted to a PDF.
                  </p>
                  
                  <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <a 
                      href={downloadUrl} 
                      download={`${file?.name.replace(/\.pptx?$/i, '')}.pdf`}
