...
export default function PdfToWordClient() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const res = await queuePdfToWordJob(originalStoragePath, file.size);
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 md:px-8 pt-32 pb-20 min-h-screen">
      <div className="text-center mb-16 relative">
        <FileText size={30} color="#60a5fa" strokeWidth={1.75} className="mx-auto mb-4" />
        <h1 className="text-3xl md:text-5xl font-extrabold text-gray-900 tracking-tight mb-4">
          PDF to Word
        </h1>
        <p className="text-gray-500 text-lg max-w-xl mx-auto leading-relaxed">
          Convert your PDF documents to editable Microsoft Word files securely and accurately.
        </p>
      </div>
            ...
            <AnimatePresence mode="wait">
                    ...
                    {file ? (
                      <div className="flex flex-col items-center justify-center gap-3">
                        ...
                        <span className="text-sm text-gray-600 font-medium truncate max-w-[200px] md:max-w-md">
                          <strong className="text-gray-900">{file.name}</strong> · {(file.size / 1024 / 1024).toFixed(2)} MB
                        </span>
                      </div>
                    ) : (
                      <>
              ...
              {status === "completed" && downloadUrl && (
                ...
                >
                  ...
                  <p className="text-gray-500 font-medium mb-10 text-lg">Your Word document is ready! Download it below.</p>
                  ...
                  <div className="flex flex-col w-full gap-4">
                    ...
                    >
                      <Download className="w-6 h-6" /> Download Word Document
                    </a>
                    <button 
                      onClick={handleReset}
