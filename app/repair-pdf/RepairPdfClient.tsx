...
import { Wrench, File as FileIcon, Loader2, Download, AlertCircle, RefreshCw, CheckCircle2 } from "lucide-react";
import { useDropzone } from "react-dropzone";
import { motion, AnimatePresence } from "framer-motion";
import { queueRepairPdfJob } from "@/app/actions/queueRepairPdfJob";
...
export default function RepairPdfClient() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const res = await queueRepairPdfJob(originalStoragePath);
    ...
    <div className="w-full">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-gray-500 text-lg max-w-xl mx-auto leading-relaxed">
          Fix corrupted or damaged PDF files and recover data effortlessly.
        </p>
      </div>
            ...
            <AnimatePresence mode="wait">
              ...
              {!file && (
                ...
                >
                  ...
                  <p className="text-xl font-bold text-gray-800 mb-2">Drop your broken PDF here</p>
              ...
              {status === "completed" && downloadUrl && (
                ...
                >
                  ...
                  <p className="text-gray-500 mb-8 max-w-sm mx-auto">
                    Your PDF has been successfully repaired and rebuilt.
                  </p>
