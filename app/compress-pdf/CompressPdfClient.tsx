...
import { UploadCloud, File as FileIcon, Loader2, Download, AlertCircle, Minimize2, FileUp, RefreshCw, CheckCircle2 } from "lucide-react";
import { useDropzone } from "react-dropzone";
import { motion, AnimatePresence } from "framer-motion";
import { queueCompressJob } from "@/app/actions/compress";
...
export default function CompressPdfClient() {
  ...
  const handleCompress = async () => {
    ...
    try {
      ...
      const res = await queueCompressJob(originalStoragePath, file.size);
      ...
      pollIntervalRef.current = setInterval(async () => {
        ...
        if (job.status === 'completed' && job.result_file_path) {
          ...
          if (pollIntervalRef.current) clearInterval(pollIntervalRef.current);
          setErrorMessage(job.error_message || "Compression failed unexpectedly.");
          setStatus("error");
        }
      }, 2000);
    ...
    <div className="container mx-auto max-w-7xl px-4 md:px-8 pt-32 pb-20 min-h-screen">
      <div className="text-center mb-16 relative">
        ...
        <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto font-medium">
          Reduce your PDF file size instantly while retaining maximum quality.
        </p>
      </div>
            ...
            <AnimatePresence mode="wait">
                ...
                >
                  ...
                  >
                    ...
                    <div className="bg-rose-100 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 transition-transform group-hover:scale-110">
                      <FileUp className="w-10 h-10 text-rose-600" />
                    </div>
              ...
              {status === "processing" && (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Compressing Document</h3>
                  <p className="text-gray-500 font-medium">Securing and optimizing your file...</p>
                </motion.div>
              )}
              ...
              {status === "completed" && downloadUrl && (
                ...
                >
                  ...
                  <p className="text-gray-500 font-medium mb-10 text-lg">Your PDF has been expertly compressed.</p>
                  ...
                  <div className="flex flex-col w-full gap-4">
                    ...
                    >
                      <RefreshCw className="w-5 h-5" /> Compress Another File
                    </button>
                  </div>
                </motion.div>
              )}
              ...
              {status === "error" && (
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-3">Compression Failed</h3>
